import 'cookie';
import { l as levels, d as dateTimeFormat, A as AstroCookies, a as attachCookiesToResponse, c as createAPIContext, b as callEndpoint, e as callMiddleware, L as Logger, f as AstroIntegrationLogger, g as getSetCookiesFromResponse, manifest } from './manifest_1aca8cbe.mjs';
import { yellow, dim, bold, cyan, red, reset } from 'kleur/colors';
import { t as trimSlashes, j as joinPaths, s as slash, p as prependForwardSlash, r as removeTrailingForwardSlash, d as collapseDuplicateSlashes } from './chunks/astro-assets-services_2a084e74.mjs';
import { A as AstroError, G as GetStaticPathsRequired, k as InvalidGetStaticPathsReturn, l as InvalidGetStaticPathsEntry, n as GetStaticPathsExpectedParams, o as GetStaticPathsInvalidRouteParam, P as PageNumberParamNotFound, p as GetStaticPathsRemovedRSSHelper, N as NoMatchingStaticPathFound, q as PrerenderDynamicEndpointPathCollide, t as LocalsNotAnObject, R as ReservedSlotName, u as renderSlotToString, v as renderJSX, w as chunkToString, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, x as ResponseSentError, y as renderPage$1 } from './chunks/astro_7f2237b0.mjs';
import 'html-escaper';
import 'clsx';
import 'node:fs';
import 'node:http';
...
const _page0  = () => import('./chunks/generic_bfd5763d.mjs');
const _page1  = () => import('./chunks/index_ee4d0536.mjs');
const _page2  = () => import('./chunks/prayertimes_8ab6375d.mjs');
const _page3  = () => import('./chunks/index_d6e92891.mjs');const pageMap = new Map([["node_modules/astro/dist/assets/endpoint/generic.js", _page0],["src/pages/index.astro", _page1],["src/pages/prayertimes.astro", _page2],["src/pages/api/newsletter/index.ts", _page3]]);
